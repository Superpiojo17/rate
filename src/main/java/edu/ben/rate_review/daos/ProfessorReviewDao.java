...
public class ProfessorReviewDao extends BaseDao {
    ...
    public List<ProfessorReview> search(String sType, String sText) throws SQLException {
        String NAME_SQL = "SELECT * FROM " + REVIEW_PROFESSOR_TABLE + " WHERE professor_first_name LIKE '%?%' OR professor_last_name LIKE '%?%' OR course LIKE '%?%' OR semester LIKE '%?%'  OR year LIKE '%?%'  OR professor_last_name LIKE '%?%'";
        ...
        try (Connection conn = this.db.getConnection()) {
            ...
            ps = conn.prepareStatement(NAME_SQL);
    ...
    public ProfessorReview findReview(Long student_course_id) {
        final String sql = "SELECT * FROM " + REVIEW_PROFESSOR_TABLE + " WHERE student_course_id = ?";
    ...
    public String deleteReview(long id) {
        ...
        String sql = "DELETE FROM " + REVIEW_PROFESSOR_TABLE + " WHERE student_course_id = ?";
    ...
    public List<ProfessorReview> listReviewsByCourse(String course) {
        ...
        String sql = "SELECT * FROM " + REVIEW_PROFESSOR_TABLE + " WHERE course = '?'";
