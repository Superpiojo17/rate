...
public class Application {
    ...
    private static void configRoutes() {
        ...
        get(REMOVEFROMCLASSLIST_PATH, EditCoursesController::showRemoveFromClassListPage, new HandlebarsTemplateEngine());
        ...
        get(APPOINTMENTS_PATH, AdminDashboardController::showAllDeptApt,
        ...
        post(DELETEAPPOINTMENT_PATH, AdminDashboardController::adminDeleteApt,
                new HandlebarsTemplateEngine());
        ...
        get(TUTORLANDING_PATH, AdminDashboardController::showManageTutorsLandingPage,
                new HandlebarsTemplateEngine());
        post(ADMINADDTUTOR_PATH, AdminEditTutorController::adminAddTutor,
                new HandlebarsTemplateEngine());
        get(ADMINADDTUTOR_PATH, AdminEditTutorController::showAddTutorsPage,
                new HandlebarsTemplateEngine());
        ...
        get(COMPLETESTUDENT_PATH, StudentDashboardController::showCompleteProfileStudentPage, new HandlebarsTemplateEngine());
        ...
        // adding courses
        get(ADDCOURSE_PATH, EditCoursesController::showAddCoursesPage,
                new HandlebarsTemplateEngine());

        post(ADDCOURSE_PATH, EditCoursesController::addCourse, new HandlebarsTemplateEngine());

        // Deleting courses
        post(DELETECOURSE_PATH, EditCoursesController::deleteCourse,
                new HandlebarsTemplateEngine());

        // editing course
        get(EDITCOURSES_PATH, EditCoursesController::showEditCoursesPage,
                new HandlebarsTemplateEngine());
        post(EDITCOURSES_PATH, EditCoursesController::updateCourse,
                new HandlebarsTemplateEngine());

        // paths for admin to view courses
        get(COURSES_PATH, EditCoursesController::showDeptCoursesPage,
                new HandlebarsTemplateEngine());

        get(COURSELANDING_PATH, AdminDashboardController::showManageCoursesLandingPage,
                new HandlebarsTemplateEngine());
        ...
        get(SELECTTUTOR_PATH, FacultyDashboardController::showSelectTutorsPage,
                new HandlebarsTemplateEngine());

        // adding a tutor
        get(ADDTUTOR_PATH, FacultyDashboardController::showAddTutorPage,
                new HandlebarsTemplateEngine());
        post(ADDTUTOR_PATH, FacultyDashboardController::addTutor, new HandlebarsTemplateEngine());

        // editing a tutor
        get(EDITTUTORS_PATH, EditTutorController::showEditTutorPage,
                new HandlebarsTemplateEngine());
        ...
        get(AUTHORIZATIONERROR_PATH, UnauthorizedController::showNotAuthorized,
                new HandlebarsTemplateEngine());

        get(NOTLOGGEDIN_PATH, UnauthorizedController::showNotLoggedIn,
                new HandlebarsTemplateEngine());
        ...
        post(ADDANNOUNCEMENT_PATH, EditAnnouncementController::addAnnouncement,
                new HandlebarsTemplateEngine());
        get(ADDANNOUNCEMENT_PATH, EditAnnouncementController::showAddAnnouncementPage,
                new HandlebarsTemplateEngine());
        get(EDITANNOUNCEMENT_PATH, EditAnnouncementController::showEditAnnouncementPage,
                new HandlebarsTemplateEngine());
        post(EDITANNOUNCEMENT_PATH, EditAnnouncementController::updateAnnouncement,
                new HandlebarsTemplateEngine());
        post(DELETEANNOUNCEMENT_PATH, EditAnnouncementController::deleteAnnouncement,
                new HandlebarsTemplateEngine());
        get(ANNOUNCEMENTS_PATH, AdminDashboardController::showEditAnnouncements,
                new HandlebarsTemplateEngine());
        post(ANNOUNCEMENTS_PATH, AdminDashboardController::addAnnouncement,
                new HandlebarsTemplateEngine());

        // path for professor overview page
        get(PROFESSOR_PATH, ProfessorController::showProfessorPage,
                new HandlebarsTemplateEngine());
        ...
        post(MASSEDITCONFIRMED_PATH, EditUserController::massEditConfirmed,
                new HandlebarsTemplateEngine());
        post(MASSEDITACTIVE_PATH, EditUserController::massEditActive,
                new HandlebarsTemplateEngine());
        post(MASSEDITYEAR_PATH, EditUserController::massEditYear,
                new HandlebarsTemplateEngine());
        post(MASSEDITROLE_PATH, EditUserController::massEditRole,
                new HandlebarsTemplateEngine());

        // paths for reviewing a professor
        get(REVIEWPROFESSOR_PATH, ProfessorReviewController::showReviewProfessorPage,
                new HandlebarsTemplateEngine());
        ...
        get(TUTORREVIEW_PATH, TutorReviewController::showTutorReview,
                new HandlebarsTemplateEngine());
        ...
        get(DEPARTMENTS_PATH, DepartmentsController::showDepartmentsPage,
                new HandlebarsTemplateEngine());
        ...
        get(ADMINDASHBOARD_PATH, AdminDashboardController::showAdminDashboardPage,
                new HandlebarsTemplateEngine());

        post(ADMINDASHBOARD_PATH, AdminDashboardController::handleFlaggedComment);

        // paths for admin managing all users
        get(ALLUSERS_PATH, AdminDashboardController::showAllUsersPage,
                new HandlebarsTemplateEngine());
        ...
        get(TUTORDASHBOARD_PATH, TutorDashboardController::showTutorDashboardPage,
                new HandlebarsTemplateEngine());
        ...
        get(ADDPROFESSOR_PATH, AdminController::showAddProfessorPage,
                new HandlebarsTemplateEngine());
        ...
        get(CHANGEPASSWORD_PATH, ChangePasswordController::showChangePasswordPage,
                new HandlebarsTemplateEngine());
        post(CHANGEPASSWORD_PATH, ChangePasswordController::changePassword);

        // Confirmation paths
        get(CONFIRMATION_PATH, ConfirmationController::showConfirmationPage,
                new HandlebarsTemplateEngine());
        post(CONFIRMATION_PATH, ConfirmationController::confirm);

        // Account activation and deactivation
        get(ACTIVATION_PATH, ActivationController::showActivationPage,
                new HandlebarsTemplateEngine());
        get(DEACTIVATION_PATH, ActivationController::showDeActivationPage,
                new HandlebarsTemplateEngine());
        ...
        // paths contact US
        get(CONTACTUS_PATH, ContactUsController::showContactUsPage,
                new HandlebarsTemplateEngine());
        ...
        get(CLASSLIST_PATH, EditCoursesController::showClassListPage,
                new HandlebarsTemplateEngine());

        get(PROFCLASSLIST_PATH, EditCoursesController::showProfClassListPage,
                new HandlebarsTemplateEngine());

        post(CLASSLIST_PATH, EditCoursesController::showClassListPage);

        // paths my account
        get(MYACCOUNT_PATH, MyAccountController::showMyAccountPage,
                new HandlebarsTemplateEngine());
        ...
        get(MAJORTUTOR_PATH, StudentDashboardController::showMajorTutorsPage,
                new HandlebarsTemplateEngine());
        post(MAJORTUTOR_PATH, StudentDashboardController::showMajorTutorsPage,
                new HandlebarsTemplateEngine());
    }
}