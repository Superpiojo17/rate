...
public class EditReviewsController {
    ...
    public static ModelAndView showDeptReviews(Request req, Response res) throws AuthException, SQLException {
    ...
    public static ModelAndView deleteReview(Request req, Response res) throws AuthException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
