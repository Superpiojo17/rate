...
public class FacultyDashboardController {
     ...
     */
    public static ModelAndView showFacultyDashboardPage(Request req, Response res) throws AuthException {
    ...
    public static ModelAndView showCompleteProfileProfPage(Request req, Response res) throws AuthException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView showAllTutorsPage(Request req, Response res) throws AuthException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView showSelectTutorsPage(Request req, Response res) throws AuthException, SQLException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView showSelectStudentsPage(Request req, Response res) throws AuthException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView showAddTutorPage(Request req, Response res) throws AuthException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView addTutor(Request req, Response res) {
        HashMap<String, Object> model = new HashMap<>();
