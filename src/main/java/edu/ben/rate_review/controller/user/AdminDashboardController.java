...
public class AdminDashboardController {
    public static ModelAndView showAdminDashboardPage(Request req, Response res) throws AuthException {
        ...
        List<ProfessorReview> allComments = reviewDao.listAllReviews();
    ...
    public static ModelAndView showAllUsersPage(Request req, Response res) throws AuthException, SQLException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView showManageCoursesLandingPage(Request req, Response res) throws AuthException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView showManageReviewsLandingPage(Request req, Response res) throws AuthException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView showEditApt(Request req, Response res) throws AuthException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView adminDeleteApt(Request req, Response res) {
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView adminUpdateApt(Request req, Response res) {
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView showManageAptLandingPage(Request req, Response res) throws AuthException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView showAllDeptApt(Request req, Response res) throws AuthException, SQLException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView showManageTutorsLandingPage(Request req, Response res) throws AuthException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static ModelAndView showEditAnnouncements(Request req, Response res) throws AuthException {
        // Just a hash to pass data from the servlet to the page
        HashMap<String, Object> model = new HashMap<>();
    ...
    public static String massRegister(Request req, Response res)
    ...
    public static String sortByLastName(Request req, Response res) {
     ...
     * @return
     */
    public static String handleFlaggedComment(Request req, Response res) {
        DaoManager dao = DaoManager.getInstance();
        ProfessorReviewDao reviewDao = dao.getProfessorReviewDao();
     ...
     * @return
     */
    public static String massEnrollStudents(Request req, Response res) {
        // DaoManager dao = DaoManager.getInstance();
