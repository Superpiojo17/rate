...
public class StudentDashboardController {
	...
	public static ModelAndView showCompleteProfileStudentPage(Request req, Response res) throws AuthException {
		// Just a hash to pass data from the servlet to the page
		HashMap<String, Object> model = new HashMap<>();
	 ...
	 * @param sDao
	 */
	private static void flagPastCourses(StudentInCourseDao sDao) {
	...
	public static ModelAndView showMajorTutorsPage(Request req, Response res) throws SQLException {
		// Just a hash to pass data from the servlet to the page
		HashMap<String, Object> model = new HashMap<>();
	...
	public static ModelAndView showCourseAllProfessorsPage(Request req, Response res) throws SQLException {
		// Just a hash to pass data from the servlet to the page
		HashMap<String, Object> model = new HashMap<>();
