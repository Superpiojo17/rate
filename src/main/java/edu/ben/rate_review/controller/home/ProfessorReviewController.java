...
public class ProfessorReviewController {
     ...
     */
    public static ModelAndView showReviewProfessorPage(Request req, Response res) {
     ...
     * @param review
     */
    private static void handlePrePopulatedButtons(HashMap<String, Object> model, ProfessorReview review) {
     ...
     * @return
     */
    public static String reviewProfessor(Request req, Response res) {
     ...
     */
    private static Long createReview(Long student_course_id, String comment, int rate_objectives, int rate_organized,
    ...
    public static ModelAndView passCourse(Request req, Response res) {
        HashMap<String, Object> model = new HashMap<>();
